...
public class ImageTrackableEventHandler : MonoBehaviour, ITrackableEventHandler {
	...
	void OnTrackingFound () 
	{
		...
		Messenger.Broadcast <bool, string> (EventManager.AR.IMAGETRACKING.ToString(), true, letter);
	}
	...
	void OnTrackingLost () 
	{
		...
		Messenger.Broadcast <bool, string> (EventManager.AR.IMAGETRACKING.ToString(), false, letter);
	}
	#endregion
