...
//		CarGameEventController.OnLetterTracking(true, letter);
		Messenger.Broadcast <bool, string> (EventManager.AR.LETTER_IMAGE_TRACKING.ToString(), true, letter);
	}
...
//		CarGameEventController.OnLetterTracking(false, letter);
		Messenger.Broadcast <bool, string> (EventManager.AR.LETTER_IMAGE_TRACKING.ToString(), false, letter);
	}
	#endregion
